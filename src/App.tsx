  ...
  return <AdminAuth onBack={() => setSection("public")}>
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="wave-card complete"><small>CICLO CONCLUÍDO</small><strong>Onda 12 de 12</strong><span>Alertas de novos pedidos</span><div><i style={{ width: "100%" }} /></div></div>
      </aside>
